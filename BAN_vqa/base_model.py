...
class BanModel(nn.Module):
    ...
    def forward(self, v, b, q, labels):
        ...
        att, logits, gw = self.v_att.forward_all(v, q_emb) # b x g x v x q
...
class BanModel_flickr(nn.Module):
    ...
    def forward(self, v, b, q, e, labels):
        ...
        att, gw = self.v_att.forward_all(v, q_emb, True, True, MINUS_INFINITE)  # b x g x v x q
